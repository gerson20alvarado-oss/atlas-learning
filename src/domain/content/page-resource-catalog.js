...
export const PAGE_RESOURCE_CATALOG = Object.freeze([
  ...
  // ==================== CAPÍTULO 5 (base 134) ====================
  // Mismo patrón, verificado con evidencia real en páginas clave antes de escribir.
  {
    bookId: HI_KOREAN_3A,
    pageNumber: 141,
    type: 'audio',
    pageTemplate: '대화',
    trackLabel: 'Track 21',
    assetPath: 'book-hi-korean-3a/Hi Korean 3A_SB_21.mp3',
  },
  {
    bookId: HI_KOREAN_3A,
    pageNumber: 143,
    ...
    pageTemplate: '듣고 말하기 1',
    trackLabel: 'Track 22',
    assetPath: 'book-hi-korean-3a/Hi Korean 3A_SB_22.mp3',
  },
  {
    bookId: HI_KOREAN_3A,
    pageNumber: 143,
    ...
    sourcePageRef: 208,
    transcriptLines: [
      { speaker: "엠마", text: "첸 씨! 어제 우리집에 왜 안 왔어요? 친구들이랑 얼마나 재미있었는데요." },
      { speaker: "첸", text: "어, 엠마 씨! 미안해요, 어제 친구 숙제를 도와주느라고 엠마 씨 집에 못 갔어요." },
      { speaker: "엠마", text: "그랬군요. 다음에는 꼭 놀러 오세요. 아, 맞다. 첸 씨, 강아지 키우죠?" },
      { speaker: "첸", text: "네, 왜요?" },
      { speaker: "엠마", text: "잘됐다! 제가 내일 갑자기 친구랑 여행 가게 됐거든요. 제 고양이 좀 부탁할게요." },
      { speaker: "첸", text: "네? 고양이를요? 어… 하지만…." },
      { speaker: "엠마", text: "괜찮아요, 괜찮아. 우리 고양이는 정말 순하거든요. 제가 맛있는 거 사 줄 테니까 주말 동안 좀 돌봐주세요. 이따가 제가 고양이 데리고 갈 테니까 준비하고 있어요! 이따 봐요! (혼잣말) 아… 어떡하지? 나 고양이 무서워하는데…." },
    ],
  },
  {
    bookId: HI_KOREAN_3A,
    ...
    pageTemplate: '듣고 말하기 2',
    trackLabel: 'Track 23',
    assetPath: 'book-hi-korean-3a/Hi Korean 3A_SB_23.mp3',
  },
  {
    bookId: HI_KOREAN_3A,
    pageNumber: 144,
    ...
    sourcePageRef: 208,
    transcriptLines: [
      { speaker: "사회자", text: "여러분도 주변 사람들에게 곤란한 부탁을 받았을 때 거절하기 힘들어서 부탁을 들어줬던 경험이 있을 것입니다. 오늘은 전문가를 모시고 거절 잘하는 방법에 대해 알아보겠습니다. 선생님, 안녕하십니까?" },
      { speaker: "전문가", text: "네, 안녕하세요?" },
      { speaker: "사회자", text: "선생님, 사람들이 원하지 않는 부탁을 받았을 때에도 쉽게 거절하지 못하는데요, 왜 그럴까요?" },
      { speaker: "전문가", text: "대부분의 사람들은 상대방이 어려운 부탁을 하면 거절하고 싶은 마음과는 반대로 거절을 못하는 경우가 많습니다. 사실은 거절하고 싶지만 그 사람과의 관계가 어색해질까 봐 어쩔 수 없이 알겠다고 한 후에 아까 그냥 거절할 걸 그랬다고 후회하는 것이지요. 하지만 이렇게 거절하는 말을 잘못 하면 너무 많은 일을 하게 되고 그 일을 끝내지 못해서 오히려 다른 사람에게 피해를 주거나 인간 관계가 나빠지게 됩니다." },
      { speaker: "사회자", text: "네, 저도 평소에 거절을 잘 못해서 곤란할 때가 많은데요, 친구의 부탁을 들어주느라고 제 일을 제때 못 할 때도 있었거든요. 어떻게 하면 거절을 잘 할 수 있을까요?" },
      { speaker: "전문가", text: "저는 세 가지 방법을 이야기하고 싶은데요, 우선, 거절을 할 때는 거절하는 이유와 함께 정확하고 솔직하게 '안 된다'고 말해야 합니다. 보통은 상대방의 기분이 상할까 봐 직접적으로 거절하지 않고 돌려서 말하려고 하지요. 하지만 돌려서 말하면 의미가 정확하게 전달되지 않을 수도 있고 상대방이 오해할 수도 있습니다. 다음으로 대안을 제시하는 것입니다. 상대방의 부탁에 대해 자신이 어디까지 할 수 있는지 얘기하고 그 이상은 안 된다고 확실하게 말하는 것입니다. 예를 들어, 친구가 갑자기 공부를 도와달라고 부탁했을 때 \"오늘은 일이 있어서 안 되지만 주말은 괜찮은데 어때?\" 하면서 대안을 제시하면 친구도 거절을 당했다고 생각하지 않을 것입니다. 마지막으로 거절을 할 때는 시작과 끝을 긍정적인 말로 하는 것입니다. 친구가 도와달라고 했을 때 \"나도 너를 정말 도와주고 싶어. 하지만 이번엔 안 될 것 같아. 다음엔 꼭 도와줄게.\" 이런 방법으로 거절하면 거절하는 사람도 덜 부담스럽고 거절당하는 사람도 훨씬 덜 기분 나쁘게 생각할 것입니다." },
      { speaker: "사회자", text: "네, 지금까지 거절을 잘하는 방법에 대해 알아봤는데요, 이런 방법을 사용한다면 거절을 훨씬 잘 할 수 있을 것 같습니다. 오늘 좋은 말씀 감사합니다." },
    ],
  },
  {
    bookId: HI_KOREAN_3A,
    ...
    pageTemplate: '대화',
    trackLabel: 'Track 24',
    assetPath: 'book-hi-korean-3a/Hi Korean 3A_SB_24.mp3',
  },
  {
    bookId: HI_KOREAN_3A,
    pageNumber: 160,
    ...
    pageTemplate: '실전 말하기',
    trackLabel: 'Track 25',
    assetPath: 'book-hi-korean-3a/Hi Korean 3A_SB_25.mp3',
  },
  {
    bookId: HI_KOREAN_3A,
    pageNumber: 137,
  ...
  },
  {
    ...
    answerLines: [
      "(1) 점심을 먹을 걸 그랬다.",
      "(2) 운동을 열심히/좀 할 걸 그랬다.",
      "(3) 쇼핑을 조금만 할 걸 그랬다. / 쇼핑을 하지 말 걸 그랬다.",
      "(4) 구두를 신지 말 걸 그랬다. / 운동화를 신을 걸 그랬다.",
    ],
  },
  {
    bookId: HI_KOREAN_3A,
    ...
    sourcePageRef: 196,
    answerLines: [
      "1. (1) 부탁을 하다  (2) 부탁을 받다  (3) 부탁을 거절하다  (4) 부탁을 들어주다",
      "2. (1)-㉰ (2)-㉱ (3)-㉮ (4)-㉯ (5)-㉲",
    ],
  },
  {
  ...
  },
  {
    ...
    answerLines: [
      "1. (1) 거절 잘하는 방법",
      "(2) 부탁을 거절하면 관계가 어색해질까 봐",
      "(3) 정확하고 솔직하게 안 된다고 말하기 / 대안을 제시하기 / 시작과 끝을 긍정적인 말로 하기",
    ],
  },
  {
    bookId: HI_KOREAN_3A,
    ...
    sourcePageRef: 196,
    answerLines: [
      "(1) 내가 농담을 했더니 친구들이 웃었다.",
      "(2) 밥을 급하게 먹었더니 소화가 안된다.",
      "(3) 비행기표를 찾아봤더니 매진이었다.",
    ],
  },
  {
    ...
    sourcePageRef: 196,
    answerLines: [
      "(1) 밤에 배고프지 않게 저녁을 많이 먹는다.",
      "(2) 부탁을 거절할 수 없게 선물을 보냈다.",
      "(3) 빨리 도착할 수 있게 택시를 타려고 한다.",
    ],
  },
  {
    bookId: HI_KOREAN_3A,
    ...
    sourcePageRef: 196,
    answerLines: [
      "1. (1) 잘못하다  (2) 화를 내다  (3) 사과하다  (4) 화가 풀리다  (5) 화해하다",
      "2. (1)-㉯ (2)-㉮ (3)-㉲ (4)-㉰ (5)-㉱",
    ],
  },
  {
    ...
    sourcePageRef: 196,
    answerLines: [
      "1. (1) 외로움을 느끼지 않고 돈도 절약하기 위해서",
      "(2) 인터넷에서 찾은 룸메이트와 사이 좋게 지낼 수 있는 방법",
    ],
  },
  {
    bookId: HI_KOREAN_3A,
    ...
    answerLines: [
      "1. (1) 귀찮아서 화를 풀기 때문에",
      "(2) 늦잠을 자서 약속에 늦었을 때 길이 막혀서 어쩔 수 없었다고 변명을 해 본 적이 있다.",
      "(3) 시간이 지나면 친구들의 화가 풀리기 때문에",
      "(4) 작은 선물을 하거나 맛있는 밥을 사 주는 것",
    ],
  },
  {
    bookId: HI_KOREAN_3A,
    ...
    sourcePageRef: 196,
    answerLines: [
      "1. (1) 친구가 약속에 늦었는데 과연 나에게 화를 냈다. → 오히려",
      "(3) 그 사람은 다른 사람과의 약속을 반드시 어기는 사람이니까 믿을 수 있어요. → 지키는",
      "(4) 그 직원은 자신의 잘못을 솔직하게 인정하고 변명했다. → 사과했다.",
      "2. (1) 아프느라고 학교에 못 갔어요. → 아파서",
      "(2) 열심히 공부하느라고 시험을 잘 봤어요. → 공부해서 / 열심히 공부하느라고 힘들었어요.",
      "(3) 운동을 안 했더니 건강이 나빠졌어요. 운동을 좀 하자 그랬어요. → 할 걸 그랬어요",
      "(6) 감기에 걸리게 손을 자주 씻고 몸을 따뜻하게 하세요. → 걸리지 않게",
    ],
  },
  {
    bookId: HI_KOREAN_3A,
    ...
    answerLines: [
      "1. (1)④ (2)② (3)① (4)③",
      "2. (1) 사흘이 멀다 하고  (2) 손이 발이 되도록 빌었는데  (3) 지는 게 이기는 거다  (4) 호구로 봤네.",
    ],
  },
  {
    bookId: HI_KOREAN_3A,
    ...
    sourcePageRef: 196,
    answerLines: [
      "얼마 전에 집안일 때문에 룸메이트와 크게 싸웠다. 내 잘못도 있었지만 너무 화가 나서 사과하지 않았다. 내가 사과를 안 했더니 친구도 더 화가 나서 더 이상 같이 살 수 없다고 했다. 만약 그때 내가 먼저 사과를 했다면 어땠을까? 그랬다면 지금 이렇게 새집을 구하느라 힘들지 않아도 될 텐데 후회된다.",
    ],
  },
  ...
  // Mismo patrón, verificado con evidencia real en páginas clave antes de escribir.
  {
    ...
    pageTemplate: '대화',
    trackLabel: 'Track 26',
    assetPath: 'book-hi-korean-3a/Hi Korean 3A_SB_26.mp3',
  },
  {
    bookId: HI_KOREAN_3A,
    pageNumber: 173,
    ...
    pageTemplate: '듣고 말하기 1',
    trackLabel: 'Track 27',
    assetPath: 'book-hi-korean-3a/Hi Korean 3A_SB_27.mp3',
  },
  {
    bookId: HI_KOREAN_3A,
    pageNumber: 173,
    ...
    sourcePageRef: 208,
    transcriptLines: [
      { speaker: "엠마", text: "카린 씨, 한국 사람들은 후식으로 볶음밥을 먹는다면서요?" },
      { speaker: "카린", text: "네? 볶음밥이요?" },
      { speaker: "엠마", text: "지난번에 한국 친구랑 닭갈비를 먹으러 갔는데 닭갈비를 다 먹고 나서 또 밥을 볶아서 먹더라고요." },
      { speaker: "카린", text: "아, 맞아요. 저도 지난번에 도우미 친구랑 신당동 떡볶이 타운에 갔는데 한국 사람들이 떡볶이를 먹은 후에 치즈 볶음밥을 만들어서 먹고 있었어요. 한국 사람들은 배도 부를 텐데 왜 또 밥을 먹을까요?" },
      { speaker: "엠마", text: "그러게요. 저기 저 사람들도 지금 볶음밥 먹고 있죠? 여기도 볶음밥 메뉴가 있나 봐요." },
      { speaker: "직원", text: "손님, 주문하신 찜닭 나왔습니다. 찜닭을 다 드신 후에 볶음밥도 드실 수 있으니까 원하시면 주문해 주세요." },
      { speaker: "카린", text: "볶음밥은 어떻게 먹으면 되나요?" },
      { speaker: "직원", text: "찜닭을 먼저 드시고 남은 양념에 밥이랑 김을 넣고 잘 섞은 다음, 불을 켜고 잠시 기다리시기만 하면 돼요." },
      { speaker: "엠마", text: "우리도 오늘은 한국 사람들이 먹는 대로 먹어 봅시다. 저희도 볶음밥 추가해 주세요!" },
      { speaker: "직원", text: "네, 알겠습니다." },
    ],
  },
  {
    bookId: HI_KOREAN_3A,
    ...
    pageTemplate: '듣고 말하기 2',
    trackLabel: 'Track 28',
    assetPath: 'book-hi-korean-3a/Hi Korean 3A_SB_28.mp3',
  },
  {
    bookId: HI_KOREAN_3A,
    pageNumber: 174,
    ...
    sourcePageRef: 208,
    transcriptLines: [
      { speaker: "빈", text: "민아야, 혹시 미역국 어떻게 끓이는지 알아?" },
      { speaker: "민아", text: "미역국? 갑자기 미역국은 왜?" },
      { speaker: "빈", text: "내일이 내 한국 친구 생일이거든. 한국 사람들은 생일날 미역국을 먹는다면서? 그래서 미역국을 끓여 주려고." },
      { speaker: "민아", text: "미역국은 끓이기 쉬워. 먼저 미역을 불려야 하는데 집에 미역은 있어? 없으면 마트에서 마른 미역을 사다가 물에 30분 정도 불려." },
      { speaker: "빈", text: "그다음엔?" },
      { speaker: "민아", text: "미역을 알맞은 크기로 잘라서 냄비에 넣어. 거기에 소고기, 다진 마늘, 참기름을 넣고 함께 볶으면서 간장으로 간을 해. 그다음에 물을 붓고 끓이기만 하면 돼." },
      { speaker: "빈", text: "정말? 진짜 간단하네." },
      { speaker: "민아", text: "응, 별로 어렵지 않으니까 내가 가르쳐 준 대로 해 봐." },
      { speaker: "빈", text: "가르쳐 줘서 고마워. 그런데 한국 사람들은 왜 생일에 미역국을 먹는 거야? 나 그게 항상 궁금했어." },
      { speaker: "민아", text: "음, 한국에서는 어머니들이 아이를 낳은 후에 꼭 미역국을 먹거든. 미역국은 영양분이 많아서 아이를 낳은 어머니들이 몸을 회복하려고 먹는 음식이야. 우리 어머니도 나를 낳고 나서 한 달 동안 미역국을 드셨다고 하더라고." },
      { speaker: "빈", text: "한 달이나? 그런데 어머니들이 먹었던 미역국을 생일에 왜 먹지?" },
      { speaker: "민아", text: "생일에 미역국을 끓이면서 부모님은 자식이 올해도 건강하기를 바라고, 자식은 그 미역국을 먹으면서 부모님의 사랑을 생각하기 때문이야. 그래서 한국 사람들은 생일인 사람에게 '미역국은 먹었어?' 하고 물어봐." },
      { speaker: "빈", text: "우와, 미역국은 사랑의 음식이네!" },
      { speaker: "민아", text: "하하, 맞아. 그런데 한국에서 미역국을 먹으면 안 되는 날도 있는 거 알아?" },
      { speaker: "빈", text: "미역국을 먹으면 안 되는 날도 있어?" },
      { speaker: "민아", text: "응, 중요한 시험이 있는 날에는 미역국을 먹으면 안 돼. 미역이 미끄러워서 시험에 떨어진다고 생각하거든. 그래서 '나 이번 시험에서 미역국 먹었어'라고 하면 시험에서 떨어졌다는 의미야." },
      { speaker: "빈", text: "어휴, 나 다음 달에 토픽 시험 있는데 미역국 먹으면 안 되겠다." },
      { speaker: "민아", text: "하하하, 시험 보는 날에만 안 먹으면 되니까 걱정하지 마." },
    ],
  },
  {
    bookId: HI_KOREAN_3A,
    ...
    pageTemplate: '대화',
    trackLabel: 'Track 29',
    assetPath: 'book-hi-korean-3a/Hi Korean 3A_SB_29.mp3',
  },
  {
    bookId: HI_KOREAN_3A,
    pageNumber: 190,
    ...
    pageTemplate: '실전 말하기',
    trackLabel: 'Track 30',
    assetPath: 'book-hi-korean-3a/Hi Korean 3A_SB_30.mp3',
  },
  {
    bookId: HI_KOREAN_3A,
    pageNumber: 167,
    ...
    sourcePageRef: 196,
    answerLines: [
      "(1) 친구가 먹는 대로 비빔밥을 먹는다.",
      "(2) 다른 사람이 가는 대로 따라갔다.",
      "(3) 선생님이 설명해 주신 대로 문제를 풀었다.",
    ],
  },
  {
    bookId: HI_KOREAN_3A,
  ...
  },
  {
    ...
    sourcePageRef: 196,
    answerLines: [
      "1. (1) 썰다  (2) 다지다  (3) 섞다  (4) 볶다  (5) 굽다  (6) 튀기다  (7) 삶다  (8) 찌다  (9) 부치다",
    ],
  },
  {
    bookId: HI_KOREAN_3A,
  ...
  },
  {
    ...
    answerLines: [
      ...
      "① 마른 미역을 물에 불린다.",
      "② 미역을 알맞은 크기로 자른다.",
      "③ 미역에 소고기, 다진 마늘과 참기름을 넣고 함께 볶는다.",
      "④ 간장으로 간을 한다.",
      "⑤ 물을 넣고 끓이기만 하면 된다.",
      "(2) 생일에 미역국을 먹으면서 부모님의 사랑을 생각하기 때문에",
      "(3) 미역이 미끄러워서 시험에 떨어진다고 생각하기 때문에",
    ],
  },
  {
    bookId: HI_KOREAN_3A,
    ...
    sourcePageRef: 196,
    answerLines: [
      "(1) 한국 드라마를 보다 보니까 듣기 실력이 늘었다.",
      "(2) 한국어로 된 책을 읽다 보니까 한국어 공부에 도움이 된다.",
      "(3) 친구와 이야기하다 보니까 좋은 생각이 났다.",
    ],
  },
  {
    bookId: HI_KOREAN_3A,
    ...
    answerLines: [
      "(1) 주스가 없으니까 녹차라도 드세요.",
      "(2) 검은색 옷이 다 팔렸으면 파란색 옷이라도 사야겠어요.",
      "(3) 한강 공원이 멀면 집 근처 공원이라도 가세요.",
    ],
  },
  {
    bookId: HI_KOREAN_3A,
    ...
    sourcePageRef: 196,
    answerLines: [
      "1. (1) 싸 먹다  (2) 비벼 먹다  (3) 말아 먹다  (4) 부어 먹다  (5) 찍어 먹다",
      "2. (1)-㉰ (2)-㉮ (3)-㉱ (4)-㉲ (5)-㉯",
    ],
  },
  {
  ...
  },
  {
    ...
    sourcePageRef: 196,
    answerLines: [
      "1. (1) 다양한 양념으로 만든 소스에 치킨을 넣어 만든다.",
      "(2) 비벼 먹는 비빔밥, 싸 먹는 삼겹살, 말아 먹는 국밥",
      "(3) 다양한 영양분을 골고루 섭취할 수 있을 뿐만 아니라 자신의 입맛에 맞게 만들어 먹을 수 있다.",
      "2. (1) 밥도둑이야  (2) 입이 짧아서  (3) 인생의 쓴맛을  (4) 김칫국부터 마시지",
    ],
  },
  {
    bookId: HI_KOREAN_3A,
    ...
    sourcePageRef: 196,
    answerLines: [
      "1. (2) 포장지가 크니까 선물 크기에 맞게 썰어서 사용하고 남은 것은 잘 보관하세요. → 잘라서",
      "(3) 나쁜 공기를 많이 섭취하면 건강에 좋지 않으니 외출할 때는 마스크를 꼭 끼세요. → 마시면",
      "(4) 두 사람은 나이뿐만 아니라 성격이나 취향도 비슷해서 잘 어우러지는 커플이에요. → 어울리는",
      "2. (1) 엄마 씨가 만든 건 다 맛있었어요. 요리를 잘한다면서요? → 잘하시네요.",
      "(3) 다음 질문을 잘 듣고 질문대로 대답해 보세요. → 질문에 맞게",
      "(4) 그 사람이 어떤 사람인지 궁금했는데 알다가 보니까 유명한 가수더라고요. → 알아 보니까",
      "(6) 토픽 신청하는 법을 모르니까 이따가 친구가 신청할 대로 따라 해야겠어요. → 신청하는 대로",
    ],
  },
  {
    bookId: HI_KOREAN_3A,
  ...
  },
  {
    ...
    sourcePageRef: 196,
    answerLines: [
      "요즘 식당에는 사람 대신 기계를 사용해 주문해야 하는 경우가 많다. 이런 키오스크에서 주문할 때에는 우선, 언어를 선택한 후에 주문할 메뉴를 선택해야 한다. 그다음에 결제 방법을 선택하고 나서 마지막으로 결제하기만 하면 된다.",
      "토픽 시험을 접수하려면 먼저 토픽 홈페이지에 회원 가입을 해야 한다. 그 후에 시험 장소를 선택한 다음에 응시료를 결제해야 한다. 마지막으로 수험표를 출력하기만 하면 된다.",
      "(1) 제일 먼저 손을 깨끗하게 씻고, 요리에 사용할 재료를 준비해야 합니다. (2) 그다음에 냄비에 물과 떡을 넣고 끓입니다. 떡이 익는 동안 어묵과 파를 알맞은 크기로 썹니다. 물이 끓은 후에 어묵, 고추장, 고춧가루, 간장, 설탕을 넣습니다. 그리고 나서 국물이 끓어서 적어지면 파를 넣습니다. (3) 마지막으로 다 익은 떡볶이를 그릇에 담기만 하면 됩니다.",
    ],
  },
]);
